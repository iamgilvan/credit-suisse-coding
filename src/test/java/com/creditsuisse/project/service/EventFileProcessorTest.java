...
public class EventFileProcessorTest {
    ...
    @Test
    public void processEventFileByLocationTest() throws java.io.FileNotFoundException {
    ...
    @Test
    public void processEventFileByLocationExceptionTest() throws java.io.FileNotFoundException {
        Mockito.when(jsonConvertor.convertJsonStringToEvent(anyString())).thenReturn(getEvent());
    ...
    @Test
    public void eventSaveExceptionTest() throws java.io.FileNotFoundException {
        Mockito.when(jsonConvertor.convertJsonStringToEvent(anyString())).thenReturn(getEvent());
